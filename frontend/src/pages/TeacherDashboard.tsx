                        ...
                        scenarios.map((scenario) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="group block h-full focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-2xl focus:ring-offset-2"
                                    aria-label={`Start ${scenario.title} scenario`}
                                >
                                    <Card className="h-full border border-gray-100 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300 bg-white flex flex-col p-8 rounded-2xl cursor-pointer">
